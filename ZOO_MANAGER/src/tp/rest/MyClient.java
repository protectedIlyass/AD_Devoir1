...
public class MyClient {
    ...
    public static void main(String args[]) throws Exception {
        ...
        //client.update_animal(new Animal("Amine", "amazon", "Arapaima gigas", UUID.randomUUID()),id.toString());
        //client.find_animal_byName("Amine");
        //client.find_animal_atPosition("49.305,1.2157357");
       // client.find_animal_nearPosition("49.65656,0.632365");
    }
}
